...
function Button({ children, disabled, to, type, onClick }) {
  ...
  const styles = {
    ...
    small: base + " px-2 py-2 md:px-6 md:py-2.5 text-xs",
    round: base + " px-2.5 py-1 md:px-3.5 md:py-2 text-s",
    secondary:
      "inline-block text-sm rounded-full font-semibold uppercase tracking-wide text-stone-500 transition-all duration-300 hover:bg-stone-300 focus:bg-stone-300 focus:outline-none focus:ring focus:ring-stone-200 focus:ring-offset-2 focus:text-stone-800 disabled:cursor-not-allowed border-2 border-stone-300 px-4 py-2.5 md:px-6 md:py-3.5",
  };
